...
from exp.exp_ecg_forecasting import Exp_Long_Term_Forecast
...
if __name__ == '__main__':
    ...
    parser.add_argument('--llm_ckp_dir', type=str, default='/root/model/meta-llama/Meta-Llama-3-8B', help='llm checkpoints dir')
